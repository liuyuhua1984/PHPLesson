                ...
                <tr>
                    <td bgcolor="#FFFFFF">
                        ...
                        if ($page) {
                            ...
                            $length = strlen(aunhtml($counter));//计算字符串的长度，替换特殊字符
...
<table width="680" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td width="42%" align="center" valign="middle" bgcolor="#FFFFFF"><span
                    class="STYLE1">&nbsp;&nbsp;页次：<?php echo $page; ?> / <?php echo $page_count; ?> 页 </span></td>
