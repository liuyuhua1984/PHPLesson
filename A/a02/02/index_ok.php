...
<table width="1002" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td width="825" align="center">
            <table width="825" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#D0D0D0">
                <tr>
                    <td align="center" bgcolor="#FFFFFF">
                        <table width="810" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td height="25" valign="bottom" background="images/sy_8.jpg">
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    ?>
                                    <table width="800" height="198" border="4" align="center" cellpadding="4"
                                           cellspacing="4" bordercolor="#FFFFFF" bgcolor="#F4F5F9">
                                        <tr>
                                            <td width="160" rowspan="4" align="center" bgcolor="#FDF8CE"><span
                                                        class="STYLE11">
<?php
...
?></span></td>
                                            <td width="600" height="21"
                                                bgcolor="#FFFFFF"><?php echo $array_3['tb_send_user']; ?> 楼主
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td align="right"><a href="#">置顶</a>、<a href="#">修改</a>、<a
                                                        href="#">删除</a>、<a href="#">回复</a></td>
                                        </tr>
                                    </table>
                                    <p>帖子回复内容：</p>
                                    <table width="800" height="91" border="4" align="center" cellpadding="4"
                                           cellspacing="4" bordercolor="#FFFFFF" bgcolor="#F4F5F9">
                                        <?php
                                        $i = 0;
                                        ...
                                        foreach ($query_4 as $value) {
                                            ...
                                            ?>
                                            <tr>
                                                <td width="160" rowspan="3" align="center" bgcolor="#FDF8CE"><span
                                                            class="STYLE11">
<?php
...
?></span></td>
                                                <td width="586"
                                                    bgcolor="#FFFFFF"><?php echo $value['tb_restore_subject'];
                                                    echo $value['tb_restore_date'] ?>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $i; ?>楼
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td height="37" align="right"><a href="#">引用</a>、<a href="#">修改</a>、<a
                                                            href="#">删除</a></td>
                                            </tr>
                                        <?php } ?>
                                    </table>
...
<map name="Map">
    ...
    <area shape="rect" coords="455,17,566,52" href="index.php?lmbs=明日论坛">
