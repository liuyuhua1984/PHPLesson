...
<table width="800" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#3E5D96">
    ...
    if ($page) {
        $page_size = 5;
        $query = "select * from tb_forum_send ";
        $result = $conn->query($query);
        $res = $result->fetchAll(PDO::FETCH_ASSOC);
        $message_count = count($res);
        $page_count = ceil($messsage_count / $page_size);
        ...
        foreach ($query_2 as $value) {
            ...
            <tr>
                <td width="35%" align="center" bgcolor="#FFFFFF">
                    <a href="index_ok.php?send_id<?php echo $value['tb_send_id']; ?>"
                       target="_blank"><?php echo $value['tb_send_subject']; ?></a>
                </td>
...
<table width="800" height="30" border="1" cellpadding="1" cellspacing="1" bgcolor="#D0D0D0">
    <tr>
        <td height="22" align="center" bgcolor="#FFFFFF">
            <span class="STYLE2">帖子统计:<?php echo $mesage_count; ?> 条&nbsp</span>
