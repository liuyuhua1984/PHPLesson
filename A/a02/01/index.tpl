...
<body>
    <table width="1002" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr><img src="images/sy_3.jpg" width="1002" height="65" border="0" usemap="#Map"> </tr>
    </table>
    <table width="1002" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="89">&nbsp;</td>
                    ...
                    <tr>
                        <td align="center" bgcolor="#FFFFFF">
                            {if $isbbs=="T"}
                                ...
                                <table width="96%" border="0" align="center" cellspacing="0" cellpadding="1" bgcolor="#CCCCCC">
                                    <tr>
                                        <td bgcolor="#FFFFFF">
                                            <table width="100%" height="23" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                                                <tr>
                                                    <td bgcolor="#E9EBEB">
                            ...
                            {if $isbbstell=="F" && $isbbs="F"}
                                <table width="96%" height="30" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#58BAE9">
                                    <tr>
                                        <td bgcolor="#FFFFFF"><div align="center"><font color="#FF000000">{ldelim}该分类暂无论坛公告或帖子{rdelim}</font></div></td>
                                    </tr>
                                </table>
                            {/if}
                        </td>
